...
def normalize_kannada(input_text: str) -> str:
	input_text1 = input_text
	
	########################################
	one_unicode_char = "ೀ ೇ ೈ ೊ ೋ"
	two_unicode_char1 = "ಿ ೕ"
	two_unicode_char2 = "ೆ ೕ"
	two_unicode_char3 = "ೆ ೖ"
	two_unicode_char4 = "ೆ ೂ"
	two_unicode_char5 = "ೊ ೕ"
	#############################################
