...
def normalize_oriya(input_text: str) -> str:
	input_text1 = input_text
	
	########################################
	one_unicode_char = "ୈ ୋ ୌ ଡ଼ ଢ଼"
	two_unicode_char1 = "େ ୖ"
	two_unicode_char2 = "େ ା"
	two_unicode_char3 = "େ ୗ"
	two_unicode_char4 = "ଡ ଼"
	two_unicode_char5 = "ଢ ଼"
