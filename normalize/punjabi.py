...
def normalize_punjabi(input_text: str) -> str:
	input_text1 = input_text
	
	########################################
	one_unicode_char = "ਲ਼ ਸ਼ ਖ਼ ਗ਼ ਜ਼ ਫ਼"
	two_unicode_char1 = "ਲ ਼"
	two_unicode_char2 = "ਸ ਼"
	two_unicode_char3 = "ਖ ਼"
	two_unicode_char4 = "ਗ ਼"
	two_unicode_char5 = "ਜ ਼"
	two_unicode_char6 = "ਫ ਼"
